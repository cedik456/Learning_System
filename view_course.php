...
if(isset($_GET['id'])) {
    // Prepare and execute SQL query to fetch course data
    $result = mysqli_query($conn, "SELECT c.*, l.LanguageName FROM Courses c INNER JOIN Languages l ON c.LanguageId = l.Id WHERE c.Id='" . $_GET['id'] . "'");
...
<head>
    ...
    <title>Course Details | Bootstrap Based Admin Template - Material Design</title>
    <!-- Favicon-->
                    ...
                    <div class="card profile-card">
                        ...
                        <div class="profile-body">
                            <div class="content-area">
                                <h3>Course ID: <?php echo $row["Id"]; ?></h3>
                                <p>Course Name: <?php echo $row["CourseName"]; ?></p>
                                <p>Language: <?php echo $row["LanguageName"]; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
