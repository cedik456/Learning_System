                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view_student.php?id=<?php echo $row["Id"]; ?>" class="btn btn-primary" title='View Record'>View</a>
                                                        <a href="update_student.php?id=<?php echo $row["Id"]; ?>" class="btn btn-success" title='Update Record'>Update</a>
                                                        <a href="delete_student.php?id=<?php echo $row["Id"]; ?>" class="btn btn-danger" title='Delete Record'>Delete</a>
                                                    </td>
