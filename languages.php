                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <a href="add_language.php" class="btn btn-primary float-right">Add New Language</a>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <?php
                                include_once 'db.php';
                                $result = mysqli_query($conn, "SELECT * FROM Languages");
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view_language.php?id=<?php echo $row["Id"]; ?>" class="btn btn-primary" title='View Record'>View</a>
                                                        <a href="update_language.php?id=<?php echo $row["Id"]; ?>" class="btn btn-success" title='Update Record'>Update</a>
                                                        <a href="delete_language.php?id=<?php echo $row["Id"]; ?>" class="btn btn-danger" title='Delete Record'>Delete</a>
                                                    </td>
